...
SECRET_KEY = 'django-insecure-l&)n7zlkz-xdr2x%7a*(7ac_@3ckr!xpmlrsj$f^ldr8zh)u5*'
...
# Configuração do Modelo de Usuário Customizado (Essencial)
AUTH_USER_MODEL = 'habilidades.Usuario'